...
const Footer = () => {
  ...
  useEffect(() => {
    const fetchUserData = async () => {
      try {
        const data = await getUserForPortfolio();
        setUserData(data);
      } catch (error) {
        console.error('Error fetching user data for footer:', error);
      }
    };
  ...
  return (
    <footer className="bg-gray-900 text-gray-100 dark:bg-gray-950 py-12">
